...
\begin{resume_header}
\name{Carlos Flury}
\program{Data Scientist - Curious human}
...
\begin{resume_section}{About Me}
  ...
  \textbf{Technical Skills}  \= Python, SQL, machine and deep learning python packages, PowerBI, Linux/Ubuntu \\*
  \textbf{Languages} \> Native in Spanish; Elementary proficiency in German and Italian\\*
  \textbf{Interests} \> Data Science, Finance, Cryptocurrencies\\*
  \end{nospacetabbing}
\end{resume_section}
